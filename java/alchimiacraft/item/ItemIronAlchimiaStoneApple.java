...
public class ItemIronAlchimiaStoneApple extends ItemFood {
	public ItemIronAlchimiaStoneApple(int par1, boolean flag) {
		super(par1,flag);
		this.setTextureName(AlchimiaCraft.resourceDomain+"iron_alchimia_stone_apple");
		this.maxStackSize = 1;
		this.setCreativeTab(AlchimiaCraft.tabAlchimiaCraft);
		this.setUnlocalizedName("iron_alchimia_stone_apple");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer player) {
		if(itemStack.getItemDamageForDisplay() < 8) {
			...
			//�����x�̉񕜗ʁA�B�������x�̉񕜗�
			player.getFoodStats().addStats(4, 0.8F);
